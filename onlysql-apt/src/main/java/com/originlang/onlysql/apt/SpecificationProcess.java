...
import com.google.auto.service.AutoService;import com.palantir.javapoet.JavaFile;import com.palantir.javapoet.MethodSpec;import com.palantir.javapoet.TypeSpec;
...
//		MethodSpec build = this.build(entityClass, env);
...
//			.addMethods(List.of(constrMethod, builder, build))
			.build();
